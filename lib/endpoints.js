...
var RestifyEndpoints = module.exports.RestifyEndpoints = function(options) {
  this.endpoints = [];
  this.middleware = [];
...
RestifyEndpoints.prototype.addEndpoint = function(endpoint) {
  if (!endpoint.name) {
...
RestifyEndpoints.prototype.addMiddleware = function(middleware) {
  var self = this;

  
};
 
RestifyEndpoints.prototype.autodiscover = function(endpointpath) {
  var self = this;
...
RestifyEndpoints.prototype.attach = function (server) {
  this.createRoutes(server);
}


RestifyEndpoints.prototype.createRoutes = function(server) {
  var self = this;
  ...
  this.endpoints.forEach(function(endpoint) {
    ...
    // You may even consider adding the authentication here:
...
RestifyEndpoints.prototype.validator = function(endpoint) {
